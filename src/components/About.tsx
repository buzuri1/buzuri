        ...
        <section id="about" className="py-24 relative">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    {/* Content */}
                    <motion.div variants={itemVariants} className="glass-card p-8 md:p-12 mb-12">
                    ...
                    >
                        {stats.map((stat) => (
                            ...
                            >
                                <div className="text-3xl md:text-4xl font-bold text-electric-blue glow-text mb-2 group-hover:scale-110 transition-transform duration-300">
                                    {stat.value}
                                </div>
