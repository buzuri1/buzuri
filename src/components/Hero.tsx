...
const Hero: React.FC = () => {
    return (
        <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
            ...
            <div className="container max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-16 items-center z-10 py-20">
                {/* Text Content */}
                <motion.div
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex gap-4 justify-center md:justify-start">
                            <a
                                href="#about"
                                className="group relative px-8 py-3 bg-electric-blue text-black font-semibold rounded-full overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(0,255,255,0.4)] hover:-translate-y-1"
                            >
                                <span className="relative z-10">About Me</span>
                            </a>
                            <a
                                href="#contact"
                                className="px-8 py-3 border border-white/20 text-white font-medium rounded-full hover:border-electric-blue hover:text-electric-blue transition-all duration-300 hover:-translate-y-1"
                            >
                                Contact
                            </a>
                        </div>
                ...
                >
                    <div className="relative group">
                        ...
                        <motion.div
                            ...
                            className="relative w-64 h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 rounded-full overflow-hidden border-2 border-electric-blue/30 shadow-[0_0_40px_rgba(0,255,255,0.15)] group-hover:border-electric-blue/60 group-hover:shadow-[0_0_60px_rgba(0,255,255,0.25)] transition-all duration-500"
                        >
                            <img
                                src={heroImage}
                                alt="Buzuri"
